...
class TestParser(unittest.TestCase):
    ...
    def test_csv_parser(self):
        ...
        result, errors = csv_parser("testparser.csv")
    ...
    def test_parser_quotes(self):
        ...
        result, errors = csv_parser("testparserquotes.csv")
    ...
    def test_wrong_number_fields(self):
        ...
        result, errors = csv_parser("testnumberoffields.csv")
        ...
        self.assertEqual(errors, 
                         [
                            (3,'Tobias,45',"wrong number of fields")
                         ])
    ...
    def test_null_values(self):
        ...
        result, errors = csv_parser("testnull.csv")
    ...
    def test_csv_parser_nested_qoutes(self):
        with open("testnestedquotes.csv", "w", encoding="utf-8") as file:
           file.write(
                'navn,alder,by\n'
                'Tobias,45,"Aarhus,""Hej"""\n'
                'Katrine,56,Vejle\n'
            )
        result, errors = csv_parser("testnestedquotes.csv")
    ...
    def test_value_error(self):
        ...
        result,errors = csv_parser("test_value_error.csv")
